...
--
-- Host: localhost:3306
-- Generation Time: Nov 24, 2017 at 10:06 PM
...
--
-- Database: `customQuizApplication`
--
CREATE DATABASE IF NOT EXISTS `customQuizApplication` DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci;
USE `customQuizApplication`;
...
CREATE TABLE `mst_test` (
  ...
  `total_question` varchar(11) NOT NULL,
  `enable` tinyint(1) NOT NULL DEFAULT '1'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
('root', '{\"angular_direct\":\"angular\",\"relation_lines\":\"true\",\"snap_to_grid\":\"on\",\"small_big_all\":\">\"}');
...
('root', '[{\"db\":\"customQuizApplication\",\"table\":\"mst_user\"},{\"db\":\"customQuizApplication\",\"table\":\"mst_useranswer\"},{\"db\":\"customQuizApplication\",\"table\":\"mst_test\"},{\"db\":\"customQuizApplication\",\"table\":\"mst_subject\"},{\"db\":\"customQuizApplication\",\"table\":\"mst_result\"},{\"db\":\"customQuizApplication\",\"table\":\"mst_question\"},{\"db\":\"customQuizApplication\",\"table\":\"mst_admin\"},{\"db\":\"customQuizApplication\",\"table\":\"about_us\"}]');
...
('customQuizApplication', 'mst_test', 'id');
...
('root', '2017-09-25 09:51:02', '{\"collation_connection\":\"utf8mb4_unicode_ci\"}');
